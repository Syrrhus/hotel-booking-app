...
import { validateCardExpiry, validateCVC, validateCardNumber, validateNumNights, validatePhoneNumber, validDate } from './validation';
...
const HotelReservationFormWrapper = () => {
  return (
...
export default HotelReservationFormWrapper;
